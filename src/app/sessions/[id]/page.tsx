          ...
          <div className="p-6 sm:p-10 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-center gap-2">
                ...
                >
                  {session.stayAvailable ? 'Stay Included' : 'Day Visit'}
                </span>
                ...
                >
                  {session.isActive ? 'Active Session' : 'Past / Archived'}
                </span>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 p-5 bg-cream border border-warm-gray rounded-2xl text-xs sm:text-sm font-light text-warm-charcoal/80">
              ...
              {/* Only show seat availability if NOT unlimited */}
              {!isUnlimited && (
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold uppercase tracking-wider text-saffron">About This Session</h3>
